...
class TextStyles {
  ...
  static TextStyle textDarkMain12 = TextStyle(fontSize: 12.sp, color: Colours.dark_app_main, height: 1.0);
  ...
  static TextStyle textWhite12 = TextStyle(fontSize: 12.sp, color: Colours.white, height: 1.0);
}
