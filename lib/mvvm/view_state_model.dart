...
class ViewStateModel with ChangeNotifier {
  ...
  bool get isFirstBusy => viewState == ViewState.first || viewState == ViewState.busy;

  bool get isErrorEmpty => viewState == ViewState.error || viewState == ViewState.empty;
  ...
  void setError(int errno, {String? message}) {
